      ...
      <div className="container-max">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 xl:gap-24 items-center">
          ...
          <div className="flex flex-col gap-8 animate-in slide-in-from-bottom-8 fade-in duration-700">
            {/* Pain-focused badge */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 dark:bg-blue-900/30 border border-blue-100 dark:border-blue-800 w-fit">
            ...
            {/* Main headline */}
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link 
                to="/login" 
                className="btn btn-primary px-8 py-4 text-base shadow-xl shadow-blue-500/20 hover:shadow-blue-500/30"
              >
                Start Free Trial
              </Link>
              <a 
            ...
            {/* Trust text */}
            <div className="flex flex-col gap-3 text-sm text-slate-500 dark:text-slate-500 pt-4 border-t border-slate-200 dark:border-slate-800 mt-4">
