  ...
  const steps = [
    {
      ...
      description: 'Paste the MLS listing link or upload the property photos.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'AI detects the inventory',
      description: 'MovSense scans every room, detects furniture and key items, and builds a detailed inventory list.'
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'We convert the inventory into cubic feet, time, and cost, so your team can send accurate quotes immediately.'
    }
  ];
